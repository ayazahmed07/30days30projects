...
export default function BirthdayWish() {
  ...
  // Constants
  const totalCandles: number = 7 // Total number of candles
  const totalBalloons: number = 7 // Total number of balloons
  ...
  return (
    ...
    <div className="min-h-screen bg-blue-300 flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-100 ease-in-out hover:shadow-xl border-2 border-black">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">Happy 30th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-600">Ayaz Ahmed</CardDescription>
            <p className="text-lg text-gray-500">June 30th</p>
          </CardHeader>
